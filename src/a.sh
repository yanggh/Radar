...
g++ -rdynamic Dlopen.cpp TinyXmlParser.cpp  DataBlock.cpp PackHead.cpp  PackHead_test.cpp HandleApi.cpp tinyxml/*.cpp  -std=c++11 -I../include  -ldl -o ../bin/PackHead_test
